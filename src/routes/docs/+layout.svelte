...
<div class="flex min-h-svh w-full bg-sidebar p-2 md:p-3" style="--sidebar-width: 16rem;">
  ...
  <!-- Sidebar -->
  <aside
    class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-sidebar lg:static lg:w-[var(--sidebar-width)] lg:translate-x-0
    {sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200"
  >
    <!-- Brand header -->
    <div class="flex items-center gap-3 px-4 py-4">
      <div class="flex h-8 w-8 items-center justify-center rounded-lg" style="background: linear-gradient(135deg, var(--buddy-purple), var(--buddy-purple-vivid));">
    ...
    <header class="flex h-12 shrink-0 items-center gap-3 border-b border-border px-6">
      ...
      <div class="ml-auto flex items-center gap-2">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="flex items-center gap-1.5 rounded-md border border-border px-2.5 py-1 text-xs text-muted-foreground transition-all hover:text-foreground hover:border-foreground/20"
        >
